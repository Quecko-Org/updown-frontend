...
// PR-R (2026-05-20): tests for `/market/{addr}?side=up|down`
// navigation deleted. The detail route is gone — the home page
// drawer is the single trade UI surface. The two route-navigation
// tests that used to live here are obsolete.
